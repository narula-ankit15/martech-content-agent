...
class InsightsAgent:
    ...
    def compute(self, project_id: str) -> ProjectInsights:
        entries = self._library_store.list_by_project(project_id)
        ...
        assets_by_id = {a.asset_id: a for a in self._asset_store.list_for_project(project_id)}
