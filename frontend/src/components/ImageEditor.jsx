...
export default function ImageEditor({ projectId, assets, campaignBrief, onClose, onCreated }) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const asset = await saveGeneratedAsset({ project_id: projectId, image_base64: dataUrl, tags: ["image-template"] });
      onCreated(asset);
    } catch (e) {
