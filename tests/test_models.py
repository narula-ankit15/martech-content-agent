...
from app.models import AudienceTone, CampaignBrief, CampaignRequest, Purpose
...
def test_campaign_request_requires_at_least_one_channel_brief():
    with pytest.raises(ValidationError, match="At least one of email_brief or whatsapp_brief"):
        CampaignRequest(project_id="p", campaign_id="c", campaign_brief=_campaign_brief())
